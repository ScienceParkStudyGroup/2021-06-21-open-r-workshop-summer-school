...
instructor: ["Marc Galland<sup>1</sup>", "Tijs Bliek<sup>1</sup>", "Enric Martínez<sup>1</sup>"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stacy Shinneman<sup>2</sup>", "Martina Ferraguti<sup>2</sup>", "Johannes de Groeve<sup>2</sup>"]     # boxed, comma-separated list of helpers' names, 
