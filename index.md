...
carpentry: "dc"
venue: "Introduction to Open Data Science with R"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Marc Galland<sup>1</sup>", "Tijs Bliek<sup>1</sup>", "Johannes de Groeve<sup>2</sup>", "Enric Martínez<sup>1</sup>"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stacy Shinneman<sup>2</sup>", "Martina Ferraguti<sup>2</sup>"]     # boxed, comma-separated list of helpers' names, 
...
<p id="discord">
  ...
  <strong>Invite Link to the Discord server is <a href="https://discord.gg/C4cUZ95fbQ">here</a></strong>.  
  <br>
  <br>
